...
public class StackQuery {
	...
	private ParserType parserType = ParserType.JACKSON;
	...
	public List<ResultData> execute() throws IOException {
		...
		if ("gzip".equals(connection.getContentEncoding())) {
			in = new GZIPInputStream(in); // If the returned json is compressed using gzip
		}
	...
	public URL buildUrl() throws MalformedURLException {
		...
		try {
			// Uri escapes the white spaces in our search term
