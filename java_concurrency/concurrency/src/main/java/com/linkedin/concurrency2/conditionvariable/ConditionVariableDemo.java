package com.linkedin.concurrency2.conditionvariable;

/**
 * Two hungry people, anxiously waiting for their turn to take soup.
 *
 * We add a condition variable to the mutex, in order to prevent busy waiting.
 */
