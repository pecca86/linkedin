package test.com.linkedin.collectionsdemo;

import com.linkedin.collectionsdemo.challengeone.Room;
import com.linkedin.collectionsdemo.iteratorchallenge.RoomServiceIterator;
...
public class RoomServiceIteratorTest {
    RoomServiceIterator service;
    Room[] rooms;
    ...
    void setUp() throws Exception {
        ...
        this.service = new RoomServiceIterator();
